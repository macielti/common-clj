...
(defrecord TelegramConsumer [config http-client prometheus jobs telegram-producer consumers]
  component/Lifecycle
  (start [component]
...
(defrecord MockTelegramConsumer [config http-client telegram-producer consumers]
  component/Lifecycle
  (start [component]
